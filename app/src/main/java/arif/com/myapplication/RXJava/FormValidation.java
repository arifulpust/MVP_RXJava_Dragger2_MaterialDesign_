    ...
    private void combineLatestEvents() {
        disposableSubscriber = new DisposableSubscriber<Boolean>() {
            ...
            public void onNext(Boolean isValidForm) {
                if (isValidForm) {
                    btnSubmit.setBackgroundColor(ContextCompat.getColor(FormValidation.this, R.color.blue));
                } else {
                    btnSubmit.setBackgroundColor(ContextCompat.getColor(FormValidation.this, R.color.gray));
                }
            }
